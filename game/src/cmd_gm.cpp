...
// Invalid syntax
	...
	sys_log(0, "%s[%d] gebannt %s für %i Stunden, Grund dafür: %s", ch->GetName(), ch->GetPlayerID(), szName, iDuration, szReason);
	 
	ch->ChatPacket(CHAT_TYPE_INFO, "%s wurde gebannt für %i Stunden, Grund dafür: %s", szName, iDuration, szReason);
}
